...
/**
 * Fetches SEO ranked keywords data for a specific domain
 * @param {string} domainId - The domain ID to get SEO data for
 * @returns {Promise<Object>} SEO data object with statistics and keywords
 */
export const getDomainSeoData = async (domainId) => {
  if (!isApiAvailable) {
    console.warn('API is unavailable, using mock SEO data');
  ...
  try {
    const response = await api.get(`/seo/${domainId}`);
    console.log(`SEO data response for domain ID ${domainId}:`, response.data);
    return response.data;
  } catch (error) {
...
/**
 * Fetches SEO competitor data for a specific domain
 * @param {string} domainId - The domain ID to get SEO competitor data for
 * @returns {Promise<Object>} SEO competitor data with metrics and statistics
 */
export const getDomainSeoCompetitors = async (domainId) => {
  if (!isApiAvailable) {
    console.warn('API is unavailable, using mock SEO competitor data');
  ...
  try {
    const response = await api.get(`/seo-competitors/${domainId}`);
    console.log(`SEO competitors response for domain ID ${domainId}:`, response.data);
    return response.data;
  } catch (error) {
